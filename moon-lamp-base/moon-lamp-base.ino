...
void setCorlor(int red,int green,int blue){  //设置灯的颜色
  char i;
...
const int led = 13;
// 网页前端，这里用了一个很长的字符串，后面也可以放在单独的文件里面
void handleRoot() {
...
////////////////////////////////////////////////// 工作方式一
  ...
  // AP SSID Name
  //String AP_NameString = "quhao's Moon Lamp - " + macID;
  String AP_NameString = "yd";
